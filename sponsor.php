...
<div class="panel panel-info">
 <div class="panel-heading head">Sponsor's Dashboard</div>
 ...
 <!-- Begin bio data div -->
              ...
              <h4>Bio Data</h4>
               <?php foreach ($sponsor as $spo){?>
		          Name: <em><?php echo $spo['name'];?></em><br/>
		          ID: <em><?php echo $spo['ID'];?></em><br/>
		          Phone: <em><?php echo $spo['phone'];?></em><br/>
		          Email: <em><?php echo $spo['email'];?></em><br/>
		          Address: <em><?php echo $spo['address'];?></em><br/>
		          Zip Code: <em><?php echo $spo['zip'];?></em><br/>
              <a class="btn btn-xs btn-warning" href="editprofile.php?uid=<?php echo $spo['uid'];?>">Edit</a>
		          <?php }?>
               </div> 
   <!-- End bio data div -->
  ...
  <!-- Begin balance div -->
              ...
              <h4>Balance</h4>
             Your balance as of now is 
		          <span class="label label-primary">KShs. <?php echo $acbal;?></span><br/>
               </div>
   <!-- End balance div --> 
...
<!-- End deposit div -->
 ...
 <!-- Begin info div -->
<div class="bg-success col-md-12 dash"> 
<h4>As a sponsor, you can also borrow loans. However, you must add a guarantor first, check below...</h4>
</div> 
<!-- End info div -->
...
<input type="hidden" name="balprev" value="<?php echo $acbal;?>" />
<?php 
$guarphone = "";
